...
val lightCyan = Color(0xFFD3EEF4)
val paleSpringBud = Color(0xFFF1EEC8)
val sandyBrown = Color(0xFFF3A46C)
val unbleachedSilk = Color(0xFFF6CFBE)
val columbiaBlue = Color(0xFFB9DCF2)

val darkOrange = Color(0xFFFF7518)